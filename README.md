<!-- LOGO -->
<p align="center">
  <img src="pics/clawd_buddy_banner.png" alt="Clawd Buddy Logo" width="700"/>
</p>
...
<p align="center">
  <img src="pics/clawd_buddy_3_4.jpeg" alt="Assembled Clawd Buddy on a desk" width="500"/>
  &nbsp;
  <img src="pics/clawd_buddy_claude_code.jpeg" alt="Claude Code view" width="500"/>
</p>

## What it does

Clawd Buddy sits on your desk and shows animated expressions on a small color display. You control it from any phone or browser by connecting to its built-in WiFi hotspot:
...
2. Open `clawd-buddy-main.ino` in Arduino IDE
...
4. Connect to the network: **`Clawd-Buddy`** · password: **`clawd1234`**
5. Open a browser and go to **`http://192.168.4.1`**

You should see the web controller:

<img src="pics/clawd_buddy_webpage.jpeg" alt="Webpage view" width="500"/>
...
The electronics case (body + back) is in the `clawd_buddy` model folder:

| File                                                                                 | Description                               |
| ------------------------------------------------------------------------------------ | ----------------------------------------- |
| [`./models/clawd_buddy/clawd_buddy_v1.stl`](./models/clawd_buddy/clawd_buddy_v1.stl) | Main case layout with body and back parts |
...
Edit these constants near the top of `clawd-buddy-main.ino`:
...
To contribute: fork the repo, make your changes, and open a pull request. Please keep the single-file structure (`clawd-buddy-main.ino`) so it stays easy for beginners to flash.
